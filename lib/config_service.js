...
function process_environment_variables(verbose) {
  const environment_variables = [
    ...
    'PEP_PROXY_MAGIC_KEY',
    'PEP_PROXY_REQUIRED_AUTHORIZATION',
    'PEP_PROXY_CACHE_TIME',
    'PEP_PROXY_DEBUG'
  ];
  ...
  if (process.env.PEP_PROXY_REQUIRED_AUTHORIZATION) {
    config.required_authorization = to_boolean(process.env.PEP_PROXY_REQUIRED_AUTHORIZATION, true);
  }
